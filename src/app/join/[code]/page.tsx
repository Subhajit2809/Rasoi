    ...
    return (
      <Shell>
        <div className="flex flex-col items-center gap-4 py-12">
          ...
          <p className="text-sm text-[#8B5E3C]">Checking invite…</p>
        </div>
      </Shell>
    );
  }
    ...
    return (
      <Shell>
        <div className="flex flex-col items-center gap-4 py-10 text-center">
          ...
          <h2 className="text-xl font-bold text-[#3D2010]">Invite not found</h2>
          <p className="text-sm text-[#8B5E3C] max-w-xs">{state.reason}</p>
          <p className="text-xs text-[#8B5E3C] max-w-xs">
            Ask your partner to generate a new code from their Kitchen Settings.
          </p>
          <Link
            href="/"
            className="mt-2 px-6 py-2.5 rounded-xl border-2 border-[#E8C9A0] text-[#8B5E3C] text-sm font-medium hover:border-[#D2691E] transition-colors"
          >
            Go Home
          </Link>
        </div>
    ...
    return (
      <Shell>
        <div className="flex flex-col items-center gap-4 py-10 text-center">
          ...
          <h2 className="text-xl font-bold text-[#3D2010]">You&apos;re in!</h2>
    ...
    return (
      <Shell>
        <div className="flex flex-col items-center gap-4 py-10 text-center">
          ...
          <h2 className="text-xl font-bold text-[#3D2010]">Couldn&apos;t join</h2>
          <p className="text-sm text-[#8B5E3C] max-w-xs">{state.reason}</p>
          <button
            type="button"
  ...
  return (
    <Shell>
      <div className="flex flex-col gap-6">
        {/* Invite card */}
        <div className="bg-[#FFF0E0] border-2 border-[#D2691E] rounded-2xl p-6 text-center">
          <p className="text-xs font-semibold tracking-widest text-[#D2691E] uppercase mb-2">
            Kitchen Invite
          </p>
          <div className="text-5xl mb-3">🍳</div>
          <h2 className="text-2xl font-bold text-[#3D2010] mb-1">
            {preview.household_name}
          </h2>
          <p className="text-sm text-[#8B5E3C]">
            {preview.region} · {DIET_LABEL[preview.diet_pref] ?? preview.diet_pref}
          </p>
          <div className="mt-4 inline-flex items-center gap-1.5 bg-white rounded-full px-3 py-1 text-xs text-[#8B5E3C] border border-[#E8C9A0]">
        ...
        <p className="text-xs text-center text-[#8B5E3C]">
